...
- Homo sapiens: [Scores](https://compbio-zhanglab.org/release/PSPire_scores/Homo_sapiens_scores.csv) [SSUP and stikcer regions](https://compbio-zhanglab.org/release/PSPire_scores/Homo_sapiens_info.csv)
