...
Pre-calculated PSPire predicted scores of the following model organism proteomes using protein structures provided by [AlphaFold](https://alphafold.ebi.ac.uk/download) (Version6) were provided under the pre_calculated_scores folder. The model incorporating the Phos feature was specifically utilized for human proteins, while the model without the Phos feature was employed for proteins from other species. If user want to predict scores for human proteins using other versions of AlphaFold, user can specify the `-s` option for Phos feature with the [provided file](https://compbio-zhanglab.org/release/PSPire_scores/PhosphoSitePlus_human_phos_data.csv). The structured supercial regions (SSUP) and sticker regions of each protein were also provided for each specie.

- Arabidopsis thaliana: [Scores](https://compbio-zhanglab.org/release/PSPire_scores/Arabidopsis_thaliana_scores.csv)   [SSUP and stikcer regions](https://compbio-zhanglab.org/release/PSPire_scores/Arabidopsis_thaliana_info.csv)
- Caenorhabditis elegans: [Scores](https://compbio-zhanglab.org/release/PSPire_scores/Caenorhabditis_elegans_scores.csv)   [SSUP and stikcer regions](https://compbio-zhanglab.org/release/PSPire_scores/Caenorhabditis_elegans_info.csv)
- Candida albicans: [Scores](https://compbio-zhanglab.org/release/PSPire_scores/Candida_albicans_scores.csv)   [SSUP and stikcer regions](https://compbio-zhanglab.org/release/PSPire_scores/Candida_albicans_info.csv)
- Danio rerio: [Scores](https://compbio-zhanglab.org/release/PSPire_scores/Danio_rerio_scores.csv)   [SSUP and stikcer regions](https://compbio-zhanglab.org/release/PSPire_scores/Danio_rerio_info.csv)
- Dictyostelium discoideum: [Scores](https://compbio-zhanglab.org/release/PSPire_scores/Dictyostelium_discoideum_scores.csv)   [SSUP and stikcer regions](https://compbio-zhanglab.org/release/PSPire_scores/Dictyostelium_discoideum_info.csv)
- Drosophila melanogaster: [Scores](https://compbio-zhanglab.org/release/PSPire_scores/Drosophila_melanogaster_scores.csv)   [SSUP and stikcer regions](https://compbio-zhanglab.org/release/PSPire_scores/Drosophila_melanogaster_info.csv)
- Escherichia coli: [Scores](https://compbio-zhanglab.org/release/PSPire_scores/Escherichia_coli_scores.csv)   [SSUP and stikcer regions](https://compbio-zhanglab.org/release/PSPire_scores/Escherichia_coli_info.csv)
- Glycine max: [Scores](https://compbio-zhanglab.org/release/PSPire_scores/Glycine_max_scores.csv)   [SSUP and stikcer regions](https://compbio-zhanglab.org/release/PSPire_scores/Glycine_max_info.csv)
- Homo sapiens: [Scores](https://compbio-zhanglab.org/release/PSPire_scores/Homo_sapiens_phos_scores.csv)   [SSUP and stikcer regions](https://compbio-zhanglab.org/release/PSPire_scores/Homo_sapiens_phos_info.csv)
- Methanocaldococcus jannaschii: [Scores](https://compbio-zhanglab.org/release/PSPire_scores/Methanocaldococcus_jannaschii_scores.csv)   [SSUP and stikcer regions](https://compbio-zhanglab.org/release/PSPire_scores/Methanocaldococcus_jannaschii_info.csv)
- Mus musculus: [Scores](https://compbio-zhanglab.org/release/PSPire_scores/Mus_musculus_scores.csv)   [SSUP and stikcer regions](https://compbio-zhanglab.org/release/PSPire_scores/Mus_musculus_info.csv)
- Oryza sativa: [Scores](https://compbio-zhanglab.org/release/PSPire_scores/Oryza_sativa_scores.csv)   [SSUP and stikcer regions](https://compbio-zhanglab.org/release/PSPire_scores/Oryza_sativa_info.csv)
- Rattus norvegicus: [Scores](https://compbio-zhanglab.org/release/PSPire_scores/Rattus_norvegicus_scores.csv)   [SSUP and stikcer regions](https://compbio-zhanglab.org/release/PSPire_scores/Rattus_norvegicus_info.csv)
- Saccharomyces cerevisiae: [Scores](https://compbio-zhanglab.org/release/PSPire_scores/Saccharomyces_cerevisiae_scores.csv)   [SSUP and stikcer regions](https://compbio-zhanglab.org/release/PSPire_scores/Saccharomyces_cerevisiae_info.csv)
- Schizosaccharomyces pombe: [Scores](https://compbio-zhanglab.org/release/PSPire_scores/Schizosaccharomyces_pombe_scores.csv)   [SSUP and stikcer regions](https://compbio-zhanglab.org/release/PSPire_scores/Schizosaccharomyces_pombe_info.csv)
- Zea mays: [Scores](https://compbio-zhanglab.org/release/PSPire_scores/Zea_mays_scores.csv)   [SSUP and stikcer regions](https://compbio-zhanglab.org/release/PSPire_scores/Zea_mays_info.csv)
